...
function getBrowser(apiKey, projectId, env = "ANON", headless = false, logger, browserbaseSessionCreateParams, browserbaseSessionID, localBrowserLaunchOptions, cdpUrlOverride) {
  return __async(this, null, function* () {
    ...
    if (env === "BROWSERBASE") {
      ...
      if (cdpUrlOverride) {
        const browser2 = yield import_test2.chromium.connectOverCDP(cdpUrlOverride);
      ...
      const validateProvider = (provider2) => {
        switch (provider2) {
          ...
          case "undetect":
            return provider2;
          default:
            throw new Error(`unrecognized ANON_PROVIDER ${provider2}`);
        }
      };
      ...
      const browser = yield import_test2.chromium.connectOverCDP(cdpUrl);
      const context = browser.contexts()[0];
      return { context, env };
    } else {
      logger({
      ...
      const context = yield import_test2.chromium.launchPersistentContext(userDataDir, {
        acceptDownloads: (_c = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.acceptDownloads) != null ? _c : true,
        headless: (_d = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.headless) != null ? _d : headless,
        viewport: {
          width: (_f = (_e = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.viewport) == null ? void 0 : _e.width) != null ? _f : 1250,
          height: (_h = (_g = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.viewport) == null ? void 0 : _g.height) != null ? _h : 800
        },
        locale: (_i = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.locale) != null ? _i : "en-US",
        timezoneId: (_j = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.timezoneId) != null ? _j : "America/New_York",
        deviceScaleFactor: (_k = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.deviceScaleFactor) != null ? _k : 1,
        args: (_l = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.args) != null ? _l : [
          "--enable-webgl",
          "--use-gl=swiftshader",
        ...
        bypassCSP: (_m = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.bypassCSP) != null ? _m : true,
        ...
        hasTouch: (_n = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.hasTouch) != null ? _n : true,
        ignoreHTTPSErrors: (_o = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.ignoreHTTPSErrors) != null ? _o : true,
        ...
        chromiumSandbox: (_p = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.chromiumSandbox) != null ? _p : false,
        devtools: (_q = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.devtools) != null ? _q : false,
        ...
        handleSIGHUP: (_r = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.handleSIGHUP) != null ? _r : true,
        handleSIGINT: (_s = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.handleSIGINT) != null ? _s : true,
        handleSIGTERM: (_t = localBrowserLaunchOptions == null ? void 0 : localBrowserLaunchOptions.handleSIGTERM) != null ? _t : true,
...
var Stagehand = class {
  ...
  log(logObj) {
    var _a2;
    logObj.level = (_a2 = logObj.level) != null ? _a2 : 1;
