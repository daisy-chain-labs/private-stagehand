...
export declare function formatSimplifiedTree(
 ...
 */
export declare function buildHierarchicalTree(
 ...
 */
export declare function getAccessibilityTree(
  page: StagehandPage,
  logger: (logLine: LogLine) => void,
): Promise<TreeResult>;
export declare function getXPathByResolvedObjectId(
 ...
 */
export declare function findScrollableElementIds(
  stagehandPage: StagehandPage,
): Promise<Set<number>>;
export declare function performPlaywrightMethod(
  stagehandPage: Page,
  logger: (logLine: LogLine) => void,
  method: string,
  args: unknown[],
