...
export interface CreateCdpUrlRequest {
  ...
  /** Whether to keep the browser session alive after the initial request. Defaults to false. */
  keepAlive?: boolean;
  /** Browser provider to use. Defaults to `browserbase`. */
  provider?: AnonApi.BrowserProvider;
}
