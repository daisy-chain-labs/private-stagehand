...
export declare class Organization {
     ...
     *     })
     */
    createOrganization(request: AnonApi.CreateOrganization, requestOptions?: Organization.RequestOptions): Promise<AnonApi.Organization>;
    /**
     ...
     *     })
     */
    getOrganization(organizationId: AnonApi.OrganizationId, request?: AnonApi.GetOrgRequest, requestOptions?: Organization.RequestOptions): Promise<AnonApi.Organization>;
    /**
     ...
     */
    deleteOrganization(organizationId: AnonApi.OrganizationId, requestOptions?: Organization.RequestOptions): Promise<AnonApi.DeleteOrganizationResponse>;
    /**
     ...
     *     })
     */
    updateOrganization(organizationId: AnonApi.OrganizationId, request: AnonApi.UpdateOrganization, requestOptions?: Organization.RequestOptions): Promise<boolean>;
    /**
     ...
     *     })
     */
    createAppUser(request: AnonApi.CreateAppUserIdToken, requestOptions?: Organization.RequestOptions): Promise<AnonApi.CreateAppUserResponse>;
    /**
     * Get the app user
     *
     ...
     *     })
     */
    appUser(request?: AnonApi.GetAppUserRequest, requestOptions?: Organization.RequestOptions): Promise<AnonApi.AppUser>;
    /**
     ...
     */
    listAppUsers(requestOptions?: Organization.RequestOptions): Promise<AnonApi.AppUserList>;
