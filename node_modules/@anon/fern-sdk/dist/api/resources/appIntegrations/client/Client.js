...
class AppIntegrations {
     ...
     */
    async listAppIntegrations(requestOptions) {
        const _response = await core.fetcher({
            url: (0, url_join_1.default)((await core.Supplier.get(this._options.environment)) ??
                environments.AnonApiEnvironment.Sandbox, "account/api/v1/appIntegrations"),
            method: "GET",
            headers: {
        ...
        switch (_response.error.reason) {
            ...
            case "timeout":
                throw new errors.AnonApiTimeoutError("Timeout exceeded when calling GET /account/api/v1/appIntegrations.");
            case "unknown":
                throw new errors.AnonApiError({
