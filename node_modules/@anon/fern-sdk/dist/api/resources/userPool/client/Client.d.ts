...
export declare class UserPool {
     ...
     *     })
     */
    createUserPool(request: AnonApi.CreateUserPool, requestOptions?: UserPool.RequestOptions): Promise<AnonApi.UserPool>;
    /**
     ...
     */
    getUserPool(userPoolId: string, requestOptions?: UserPool.RequestOptions): Promise<AnonApi.UserPool>;
    /**
     * This endpoint updates an existing UserPool's properties.
     *
     * @param {AnonApi.UserPoolId} userPoolId - ID of the UserPool to update
     * @param {AnonApi.UpdateUserPool} request
     * @param {UserPool.RequestOptions} requestOptions - Request-specific configuration.
     *
     * @example
     *     await client.userPool.updateUserPool("string", {
     *         name: "string",
     *         description: "string",
     *         authorization: {
     *             jwksUri: "string",
     ...
     *     })
     */
    updateUserPool(userPoolId: AnonApi.UserPoolId, request: AnonApi.UpdateUserPool, requestOptions?: UserPool.RequestOptions): Promise<boolean>;
    /**
     ...
     */
    listUserPools(requestOptions?: UserPool.RequestOptions): Promise<AnonApi.UserPoolList>;
