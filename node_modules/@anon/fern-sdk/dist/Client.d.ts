...
export declare class AnonApiClient {
    protected readonly _options: AnonApiClient.Options;
    constructor(_options: AnonApiClient.Options);
    protected _actions: Actions | undefined;
    get actions(): Actions;
    protected _activity: Activity | undefined;
    get activity(): Activity;
    protected _appIntegrations: AppIntegrations | undefined;
    get appIntegrations(): AppIntegrations;
    protected _appUserIdToken: AppUserIdToken | undefined;
    get appUserIdToken(): AppUserIdToken;
    ...
    get runtimeLog(): RuntimeLog;
    protected _sdkClient: SdkClient | undefined;
    get sdkClient(): SdkClient;
