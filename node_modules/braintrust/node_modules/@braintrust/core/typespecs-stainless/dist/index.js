...
var openAIModelParamsSchema = import_zod7.z.object({
  ...
  response_format: import_zod7.z.union([
    ...
    import_zod7.z.object({
      ...
      json_schema: import_zod7.z.object({
        name: import_zod7.z.string(),
        description: import_zod7.z.string().optional(),
        schema: import_zod7.z.record(customTypes.unknown).optional(),
...
var projectScoreTypeEnum = import_zod11.z.enum(["slider", "categorical", "weighted", "minimum", "maximum", "online"]).describe("The type of the configured score").openapi("ProjectScoreType");
...
var projectScoreSchema = import_zod11.z.object({
  ...
  config: import_zod11.z.object({
    ...
    destination: import_zod11.z.literal("expected").nullish(),
...
var objectReferenceSchema = import_zod12.z.object({
  object_type: eventObjectType.describe(
    "Type of the object the event is originating from."
  ),
  object_id: import_zod12.z.string().uuid().describe("ID of the object the event is originating from."),
  id: import_zod12.z.string().describe("ID of the original event."),
  _xact_id: import_zod12.z.string().describe("Transaction ID of the original event.")
});
...
var experimentEventSchema = import_zod12.z.object({
  ...
  dataset_record_id: import_zod12.z.string().nullish().describe(
...
var insertSystemControlFieldsSchema = import_zod12.z.object({
  ...
  [PARENT_ID_FIELD]: import_zod12.z.string().nullish().describe(
    [
...
var attachmentReferenceSchema = import_zod13.z.object({
