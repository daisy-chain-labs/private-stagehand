...
class BrowsingContextImpl {
    ...
    constructor(id, parentId, userContext, cdpTarget, eventManager, browsingContextStorage, realmStorage, url, originalOpener, unhandledPromptBehavior, logger) {
        ...
        this.#navigationTracker = new NavigationTracker_js_1.NavigationTracker(url, id, eventManager);
    }
    ...
    #initListeners() {
        this.#cdpTarget.cdpClient.on('Page.frameNavigated', (params) => {
            ...
            this.#navigationTracker.frameNavigated(params.frame.url + (params.frame.urlFragment ?? ''));
    ...
    async navigate(url, wait) {
        ...
        const commandNavigation = this.#navigationTracker.createCommandNavigation(url);
    ...
    async reload(ignoreCache, wait) {
        ...
        this.#resetLifecycleIfFinished();
        const commandNavigation = this.#navigationTracker.createCommandNavigation(this.#navigationTracker.url);
